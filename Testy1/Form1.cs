                        ...
                        if (form22.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                        {
                            ...
                            for (int i = 1; i < exlLeng; i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    string newSBDfolderFullPath = Path.Combine(parent, SBD_Color);
                                    DirectoryInfo D3 = Directory.CreateDirectory(newSBDfolderFullPath);
                                    //MessageBox.Show(newSBDfolderFullPath);
                                    D3.CreateSubdirectory("10_XMLs_org");
                                    ...
                                    foreach (string f in xmlList)
                                    {
                                        ...
                                        // 
                                        // 
                                        File.Copy(Path.Combine(xmlPath, fName), Path.Combine(Path.Combine(parent, Path.Combine(SBD_Color, "10_XMLs_org")), fName), true);
                                        copyCounter += 1;
                                    }
